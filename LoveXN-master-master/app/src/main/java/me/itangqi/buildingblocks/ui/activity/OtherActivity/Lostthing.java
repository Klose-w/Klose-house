...
import me.itangqi.buildingblocks.ui.activity.DialogActivity.LoseDialog;
import me.itangqi.buildingblocks.widget.RefreshListView;

public class Lostthing extends AppCompatActivity {
RefreshListView swlistview;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lostthing);
        swlistview = (RefreshListView ) findViewById(R.id.loseviewsw);
        ...
        SimpleAdapter simpleAdapter =new SimpleAdapter(this,listItems,R.layout.lostlist,
        ...
        swlistview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                final AlertDialog.Builder diglog=new AlertDialog.Builder(Lostthing.this);

                View view1= LayoutInflater.from(Lostthing.this).inflate(R.layout.activity_lose_dialog,null);
                ...
                pt.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(Lostthing.this, ImageShower.class);
